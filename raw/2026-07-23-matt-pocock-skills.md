...
- [`/grill-with-docs`](https://github.com/mattpocock/skills/blob/main/skills/engineering/grill-with-docs/SKILL.md) - same as `/grill-me`, but adds more goodies (see below)
...
- License: MIT
- Latest release (as of clip): v1.1.0 (2026-07-08)
- Stars (as of clip): ~183k
- Languages: Shell 77.2%, JavaScript 22.8%
